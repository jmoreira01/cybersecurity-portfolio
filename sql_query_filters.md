# SQL Query Filters for Security Enhancement

## Activity Overview
This project is part of the Google Cybersecurity course, where I applied SQL query filters to enhance system security for my organization. As a cybersecurity analyst, I investigated potential security incidents and updated employee systems by retrieving specific data from database tables using SQL.

## Project Description
My organization aims to strengthen system security by addressing potential issues and updating employee computers. I used SQL with filters to perform security-related tasks, including investigating login attempts and identifying employees for system updates. The following steps outline my approach:

### Retrieve After-Hours Failed Login Attempts
A potential security incident occurred after business hours (after 18:00), requiring investigation of all failed login attempts during this period.

This SQL query filters for failed login attempts after 18:00:
```sql
...
A suspicious event on 2022-05-09 prompted investigation of login activity on that date and the previous day (2022-05-08).

This SQL query filters for login attempts on 2022-05-09 or 2022-05-08:
```sql
SELECT * FROM log_in_attempts
...
+----------+----------+------------+------------+---------+-----------------+---------+
75 rows in set (0.066 sec)
```

### Retrieve Login Attempts Outside of Mexico
Suspicious login attempts outside Mexico required investigation.

This SQL query filters for login attempts not originating from Mexico:
```sql
SELECT * FROM log_in_attempts
...
+----------+----------+------------+------------+---------+-----------------+---------+
144 rows in set (0.110 sec)
```

### Retrieve Employees in Marketing
The Marketing department’s East building employees needed computer updates.

This SQL query filters for Marketing employees in the East building:
```sql
...
Employees in Finance and Sales required a different security update.

This SQL query filters for employees in Finance or Sales:
```sql
SELECT * FROM employees
...
A security update was needed for employees outside the Information Technology department.

This SQL query filters for employees not in IT:
```sql
SELECT * FROM employees
